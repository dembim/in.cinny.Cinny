# Cinny desktop
[Cinny desktop](https://github.com/dembim/cinny-desktop.git) is made with Tauri and built using npm and cargo packages. Cinny itself has node dependencies managed with npm as well.
